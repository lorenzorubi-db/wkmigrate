"""Tests for trigger translator methods."""
...
def test_translate_schedule_trigger_parses_result(trigger_definition, expected_result):
...
def test_translate_schedule_trigger_ignores_extra_properties(extra_property, extra_value):
    input_trigger = {
        "properties": {
            "recurrence": {
                "frequency": "Day",
...
def test_parse_cron_expression(recurrence, expected_result):
...
def test_parse_cron_expression_warnings(recurrence):
